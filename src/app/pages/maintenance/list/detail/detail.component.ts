...
import { MaintenanceDetail } from 'src/app/models/maintenance.model';
...
export class DetailComponent implements OnInit {
  ...
  handleOk(): void {
    ...
    switch (this.method) {
      case 'POST':
        this.mservice.postMaintenance(this.maintenance).subscribe(() => {
          this.dateUpdate.emit();
        });

      case 'PUT':
        this.mservice.putMaintenance(this.maintenance).subscribe(() => {
          this.dateUpdate.emit();
        });
    }
  }
